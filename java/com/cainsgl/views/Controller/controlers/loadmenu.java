...
import com.cainsgl.views.Controller.Tools.*;
import com.cainsgl.views.Controller.Tools.enums.Arrow;
import com.cainsgl.views.Controller.Tools.enums.TipSpecies;
import com.cainsgl.views.loadMenuApp;
        ...
        loadButton.setOnAction(e ->
                {
                    ...
                    String user = load.load(accountField.getText());
                    loadButton.setDisable(true);
                    if (user != null)
                    {
                        if(user.equals("捕鱼小达人"))
                        {
                            loadMenuApp.id=1;
                        }else
                        {
