...
import com.cainsgl.views.Controller.inter.init;
...
public class TipControler implements init
{
    ...
    public static AnchorPane getTip(com.cainsgl.views.Controller.Tools.enums.TipSpecies Specie, String Measge)
    {
    ...
    {
        font32 = Font.loadFont(getClass().getResourceAsStream("/iconfont.ttf"), 32);
    }
